...
class LaplacianConditional(EntropyModel):
    r"""Laplacian conditional layer rewritten by 1ch
    """
    ...
    def _standardized_cumulative(self, inputs: Tensor) -> Tensor:
        exp = torch.exp(-torch.abs(inputs))
...
class LogisticConditional(EntropyModel):
    r"""Laplacian conditional layer rewritten by 1ch
    """
